    ...
    <div className="h-screen overflow-hidden p-3 sm:p-5 lg:p-7">
      <div className="mx-auto flex h-full max-w-[1500px] gap-4">
        ...
        >
          <div className="mb-8 flex items-center justify-between px-2">
            <Link to="/dashboard" className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-[10px] font-extrabold uppercase tracking-[0.18em] text-base-content/40">
                  Move money simply
                </div>
              </div>
            </Link>
          ...
          <div className="mb-3 px-4 text-[10px] font-extrabold uppercase tracking-[0.2em] text-base-content/35">
            Menu principal
          </div>
          <ul className="menu gap-1 p-0">{links(navItems)}</ul>
          <div className="mb-3 mt-8 px-4 text-[10px] font-extrabold uppercase tracking-[0.2em] text-base-content/35">
            Gérer
          </div>
          <ul className="menu gap-1 p-0">{links(manageItems)}</ul>
          <div className="mt-auto rounded-3xl bg-base-200/70 p-4">
            <div className="mb-2 flex items-center gap-2 text-sm font-bold">
              <CircleHelp className="size-4 text-primary" /> Besoin d’aide ?
            </div>
        ...
        <section className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden rounded-[2rem] border border-base-300/60 bg-base-100/80 shadow-xl shadow-base-content/5 backdrop-blur-sm">
          <header className="flex min-h-[92px] shrink-0 items-center justify-between gap-4 border-b border-base-200/80 px-5 sm:px-8">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-xs font-extrabold uppercase tracking-[0.18em] text-primary">
            ...
            <div className="flex items-center gap-2 sm:gap-4">
              <button className="btn btn-ghost btn-circle relative">
                ...
                <span className="absolute right-2 top-2 size-2 rounded-full bg-secondary ring-2 ring-base-100" />
              </button>
...
export function EmptyState({
  ...
  return (
    <div className="rounded-3xl border border-dashed border-base-300 p-8 text-center">
      <Icon className="mx-auto mb-3 size-8 text-base-content/25" />
      <p className="font-bold">{title}</p>
      <p className="mt-1 text-sm text-base-content/50">{text}</p>
    </div>
  )
}
