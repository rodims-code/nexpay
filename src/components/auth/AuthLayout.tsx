...
export function AuthLayout({
  ...
  return (
    <div className="relative min-h-dvh overflow-x-hidden bg-[radial-gradient(circle_at_top,_rgba(34,197,94,0.10),_transparent_32%),radial-gradient(circle_at_bottom_right,_rgba(59,130,246,0.10),_transparent_28%),linear-gradient(180deg,_hsl(var(--b1))_0%,_hsl(var(--b2))_100%)] font-sans">
      <div className="mx-auto flex min-h-dvh w-full items-start px-3 py-3 sm:px-5 sm:py-4 lg:items-center lg:px-8">
        <div className="grid min-h-[calc(100dvh-1.5rem)] w-full overflow-visible rounded-[2rem] border border-base-300/70 bg-base-100/90 shadow-[0_30px_90px_-45px_rgba(15,23,42,0.6)] backdrop-blur-xl sm:min-h-[calc(100dvh-2rem)] lg:grid-cols-[1.08fr_0.92fr]">
          {/* Visual panel */}
          ...
          {/* Form panel */}
          <div className="relative flex min-h-full flex-col justify-between overflow-visible bg-base-100/95 p-5 sm:p-8 lg:p-10">
