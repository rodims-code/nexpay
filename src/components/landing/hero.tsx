    ...
    <section id="hero" className="hero min-h-[92vh] pt-24">
      <div className="hero-content grid max-w-7xl items-center gap-14 px-4 py-12 lg:grid-cols-[1.05fr_0.95fr] lg:px-8">
        ...
        >
          ...
          <div className="space-y-5">
            <h1 className="max-w-3xl text-5xl font-black leading-[0.95] tracking-tight text-balance text-base-content sm:text-6xl lg:text-7xl">
              Envoyez de l’argent en Afrique, depuis l’Afrique ou l’Europe.
            </h1>
            <p className="max-w-2xl text-lg leading-8 text-base-content/70 sm:text-xl">
              NexPay vous permet d’envoyer de l’argent d’un pays africain à un
        ...
        >
          ...
          <div className="card relative overflow-hidden border border-base-200 bg-base-100/95 shadow-2xl shadow-base-300/20">
            ...
            <div className="card-body relative p-6 sm:p-8">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <h2 className="mt-1 text-2xl font-bold">Nouveau transfert</h2>
                </div>
              ...
              <div className="mt-6 rounded-[1.75rem] border border-base-200 bg-base-200/45 p-5">
                <div className="flex items-center justify-between">
                  <div>
                    <div className="text-sm text-base-content/55">
                      Destinataire
                    </div>
                    <div className="mt-1 text-xl font-bold">Paul · Sénégal</div>
                    <div className="text-sm text-base-content/55">
                      +221 XX XXX XX XX
                    </div>
                  </div>
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  <div>
                    ...
                    <div className="text-2xl font-black">10 000 XAF</div>
                  </div>
                  <div>
                    <div className="text-sm text-base-content/55">
                      Frais + conversion
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                <div className="rounded-2xl border border-base-200 bg-base-100 p-4">
                  ...
                  <p className="mt-2 text-sm leading-6 text-base-content/60">
                    Mobile Money selon le pays et la couverture.
                  </p>
                </div>
                <div className="rounded-2xl border border-base-200 bg-base-100 p-4">
                  <div className="flex items-center gap-2 text-sm font-semibold">
                  ...
                  <p className="mt-2 text-sm leading-6 text-base-content/60">
                    Visa, Mastercard ou méthode disponible.
                  </p>
                </div>
              </div>
              <div className="flex items-center gap-2 rounded-2xl bg-success/10 px-4 py-3 text-sm font-medium text-success">
                <CheckCircle2 className="size-4" />
                Résumé clair avant confirmation par PIN
              </div>
            </div>
          </div>
          <motion.div
            ...
            className="card absolute -bottom-6 -left-4 hidden border border-base-200 bg-base-100/95 shadow-xl backdrop-blur md:block"
          >
