...
var _lazy_9a57c0ed3ce57b89 = defineLazyEventHandler(() => import("./_chunks/ssr-renderer.mjs"));
var findRoute = /* @__PURE__ */ (() => {
	const data = {
		route: "/**",
		handler: _lazy_9a57c0ed3ce57b89
	};
	return ((_m, p) => {
		return {
			data,
...
[].filter(Boolean);
//#endregion
//#region node_modules/.pnpm/nitro-nightly@3.0.1-20260923-001540-22b17bb3/node_modules/nitro-nightly/dist/runtime/internal/error/prod.mjs
...
//#endregion
//#region node_modules/.pnpm/nitro-nightly@3.0.1-20260923-001540-22b17bb3/node_modules/nitro-nightly/dist/runtime/internal/app.mjs
var APP_ID = "default";
...
//#endregion
//#region node_modules/.pnpm/nitro-nightly@3.0.1-20260923-001540-22b17bb3/node_modules/nitro-nightly/dist/presets/vercel/runtime/isr.mjs
...
function isrRouteRewrite(reqUrl, xNowRouteMatches) {
	...
	const isrURL = (xNowRouteMatches ? new URLSearchParams(xNowRouteMatches).get("__isr_route") : null) ?? reqParams.get("__isr_route");
	if (!isrURL) return;
	reqParams.delete(ISR_URL_PARAM);
	return [isrURL, reqParams.toString()];
}
//#endregion
//#region node_modules/.pnpm/nitro-nightly@3.0.1-20260923-001540-22b17bb3/node_modules/nitro-nightly/dist/presets/vercel/runtime/vercel.web.mjs
